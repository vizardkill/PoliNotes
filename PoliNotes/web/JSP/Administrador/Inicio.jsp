                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-header">
                        <div class="user-pic rounded-circle">
                            <img class="img-fluid img-thumbnail rounded-circle" src="../../img/web/Sidebar/user.jpg" alt="User picture">
                        </div>
                        <div class="user-info">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card-group">
                            ...
                            <div class="card stylish-color mr-4 text-white">
                                <div class="card-body">
                                    <div class="clearfix">
                            ...
                            <div class="card bg-info text-white mr-4">
                                <div class="card-body">
                                    <div class="clearfix">
                                        <div class="float-left">
                                        ...
                                        <div class="float-right">
                                            <p><strong>Universidades Registradas</strong></p>
                                            <h1 class="h1 text-center">1</h1>
                                        </div>
                                    </div>
                                    <p class="card-text mt-3"><span class="text-white"><i class="fa fa-question-circle"></i>
                                            Todas
                                            las universidades registradas en la plataforma</span></p>
                                </div>
                            </div>

                            <div class="card unique-color text-white mr-4">
                                <div class="card-body">
                                    <div class="clearfix">
                                        <div class="float-left">
                            ...
                            <div class="card rgba-indigo-strong mr-4">
                                <div class="card-body">
                                    <div class="clearfix">
                                        <div class="float-left">
