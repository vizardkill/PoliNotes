...
-- Creacion de la vista de MateriasxFacultad
CREATE OR REPLACE VIEW v_Materias AS 
    SELECT MATERIA.ID_MATERIA, MATERIA.CODIGO_MATERIA, MATERIA.NOMBRE_MATERIA, FACULTAD.CODIGO_FACULTAD, FACULTAD.NOMBRE_FACULTAD
    FROM MATERIA
